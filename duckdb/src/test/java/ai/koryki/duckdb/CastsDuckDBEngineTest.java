...
public class CastsDuckDBEngineTest extends BaseEngineTest<HeaderInfo> {
    ...
    @Override protected String queriesRoot() { return "src/test/resources/ai/koryki/duckdb/queries/casts"; }
    @Override protected String expectedCsv() { return "src/test/resources/ai/koryki/duckdb/expected/casts/csv"; }
    @Override protected String expectedSql() { return "src/test/resources/ai/koryki/duckdb/expected/casts/sql"; }
    ...
    public void testSingleFile() throws IOException {
        ...
        Path kql = Path.of("src/test/resources/ai/koryki/duckdb/queries/casts/privatetest/totime.kql");
