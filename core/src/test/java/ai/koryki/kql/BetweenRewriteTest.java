 ...
 * anyway — the time was discarded and the bound moved to the next midnight, which turned {@code AND
 * "…17:00:00"} into a range reaching seven hours further than written.
 *
...
class BetweenRewriteTest {
    ...
    private static String where(String upper) {
        String kql =
                "FIND orders o FILTER o.delivered_date BETWEEN \"1996-07-01 00:00:00\" AND \""
                        + upper
                        + "\" FETCH o.order_id";
    ...
    private static void assertWidenedToNextMidnight(String upper) {
        ...
        assertTrue(
                sql.contains("< TIMESTAMP '1997-01-01 00:00:00'"),
    ...
    private static void assertKeptLiteral(String upper) {
        ...
        assertTrue(
                sql.contains("BETWEEN")
                        && sql.contains("TIMESTAMP '1996-12-31 " + upper.substring(11) + "'"),
    ...
    void aDateUpperBoundStillCoversItsWholeDay() {
        String kql =
                "FIND orders o FILTER o.delivered_date BETWEEN \"1996-07-01\" AND \"1996-12-31\""
                        + " FETCH o.order_id";
        String sql =
