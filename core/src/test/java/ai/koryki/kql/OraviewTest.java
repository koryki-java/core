...
public class OraviewTest {
    ...
    public static final String EXPECTED_SQL =
            "src/test/resources/ai/koryki/core/expected/kql/oraview/sql";
    ...
    public void dialect_1() throws IOException {
        ...
        Path expectedSql =
                TestUtil.expected(p, Path.of(ORAVIEW_ROOT), Path.of(EXPECTED_SQL), ".sql");
