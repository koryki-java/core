...
public class Walker {
    ...
    public static <V extends Collector<R>, R> R apply(Query query, V v) {
        new Walker().walk(query, v);
        return v.collect();
    }

    public static <V extends Collector<R>, R> R apply(Block block, V v) {
        new Walker().walk(block, v);
        return v.collect();
    }

    public static <V extends Collector<R>, R> R apply(Set set, V v) {
        new Walker().walk(set, v);
        return v.collect();
    }

    public static <V extends Collector<R>, R> R apply(Select select, V v) {
        new Walker().walk(select, v);
        return v.collect();
    }

    public static <V extends Collector<R>, R> R apply(Join join, V v) {
        new Walker().walk(join, v);
        return v.collect();
    }

    public static <V extends Collector<R>, R> R apply(Source table, V v) {
        new Walker().walk(table, v);
        return v.collect();
    }

    public static <V extends Collector<R>, R> R apply(Out out, V v) {
        new Walker().walk(out, v);
        return v.collect();
    }

    public static <V extends Collector<R>, R> R apply(LogicalExpression logicalExpression, V v) {
        new Walker().walk(logicalExpression, v);
        return v.collect();
    }

    public static <V extends Collector<R>, R> R apply(
            UnaryLogicalExpression unaryLogicalExpression, V v) {
        new Walker().walk(unaryLogicalExpression, v);
        return v.collect();
    }

    public static <V extends Collector<R>, R> R apply(Group group, V v) {
        new Walker().walk(group, v);
        return v.collect();
    }

    public static <V extends Collector<R>, R> R apply(Order order, V v) {
        new Walker().walk(order, v);
        return v.collect();
    }

    public static <V extends Collector<R>, R> R apply(Expression expression, V v) {
        new Walker().walk(expression, v);
        return v.collect();
    }

    public static <V extends Collector<R>, R> R apply(Function function, V v) {
        new Walker().walk(function, v);
        return v.collect();
    }

    public static <V extends Collector<R>, R> R apply(Field column, V v) {
        new Walker().walk(column, v);
        return v.collect();
    }

    public static <V extends Collector<R>, R> R apply(Exists exists, V v) {
        new Walker().walk(exists, v);
        return v.collect();
    }

    public static <V extends Visitor, R> R apply(
            Query query, V v, java.util.function.Function<V, R> f) {
        new Walker().walk(query, v);
        return f.apply(v);
    }

    public static <V extends Visitor, R> R apply(
            Block block, V v, java.util.function.Function<V, R> f) {
        new Walker().walk(block, v);
        return f.apply(v);
    }

    public static <V extends Visitor, R> R apply(
            Set set, V v, java.util.function.Function<V, R> f) {
        new Walker().walk(set, v);
        return f.apply(v);
    }

    public static <V extends Visitor, R> R apply(
            Select select, V v, java.util.function.Function<V, R> f) {
        new Walker().walk(select, v);
        return f.apply(v);
    }

    public static <V extends Visitor, R> R apply(
            Join join, V v, java.util.function.Function<V, R> f) {
        new Walker().walk(join, v);
        return f.apply(v);
    }

    public static <V extends Visitor, R> R apply(
            Source table, V v, java.util.function.Function<V, R> f) {
        new Walker().walk(table, v);
        return f.apply(v);
    }

    public static <V extends Visitor, R> R apply(
            Out out, V v, java.util.function.Function<V, R> f) {
        new Walker().walk(out, v);
        return f.apply(v);
    }

    public static <V extends Visitor, R> R apply(
            LogicalExpression logicalExpression, V v, java.util.function.Function<V, R> f) {
        new Walker().walk(logicalExpression, v);
        return f.apply(v);
    }
    ...
    public static <V extends Visitor, R> R apply(
            ...
            V v,
            java.util.function.Function<V, R> f) {
        new Walker().walk(unaryLogicalExpression, v);
        return f.apply(v);
    }

    public static <V extends Visitor, R> R apply(
            Group group, V v, java.util.function.Function<V, R> f) {
        new Walker().walk(group, v);
        return f.apply(v);
    }

    public static <V extends Visitor, R> R apply(
            Order order, V v, java.util.function.Function<V, R> f) {
        new Walker().walk(order, v);
        return f.apply(v);
    }

    public static <V extends Visitor, R> R apply(
            Expression expression, V v, java.util.function.Function<V, R> f) {
        new Walker().walk(expression, v);
        return f.apply(v);
    }

    public static <V extends Visitor, R> R apply(
            Function function, V v, java.util.function.Function<V, R> f) {
        new Walker().walk(function, v);
        return f.apply(v);
    }

    public static <V extends Visitor, R> R apply(
            Field column, V v, java.util.function.Function<V, R> f) {
        new Walker().walk(column, v);
        return f.apply(v);
    }

    public static <V extends Visitor, R> R apply(
            Exists exists, V v, java.util.function.Function<V, R> f) {
        new Walker().walk(exists, v);
        return f.apply(v);
    }
    ...
    public boolean walk(Block block, Visitor visitor) {
        ...
        return visitor.visit(deque, block)
                && visitScoped(block, () -> walk(block.getSet(), visitor), visitor::leave);
    }
                ...
                && visitScoped(
                        ...
                        () ->
                                walk(select.getStart(), visitor)
                                        ...
                                        && select.getGroup().stream()
                                                .allMatch(j -> walk(j, visitor))
                                        && select.getOrder().stream()
                                                .allMatch(j -> walk(j, visitor)),
                        visitor::leave);
    }
                ...
                && visitScoped(
                        ...
                        () ->
                                walk(join.getSource(), visitor)
                                        && join.getJoin().stream().allMatch(j -> walk(j, visitor)),
                        visitor::leave);
    }
                ...
                && visitScoped(
                        ...
                        () ->
                                table.getOut().stream().allMatch(o -> walk(o, visitor))
                                        ...
                                        && table.getOrder().stream()
                                                .allMatch(o -> walk(o, visitor)),
                        visitor::leave);
    }
                ...
                && visitScoped(
                        ...
                        () ->
                                walk(expression.getExists(), visitor)
                                        ...
                                        && expression.getRight().stream()
                                                .allMatch(e -> walk(e, visitor)),
                        visitor::leave);
    }
                ...
                && visitScoped(
                        ...
                        () ->
                                walk(expression.getSelect(), visitor)
                                        ...
                                        && walk(expression.getLogical(), visitor),
                        visitor::leave);
    }
    ...
    public boolean walk(Function function, Visitor visitor) {
        ...
        return visitor.visit(deque, function)
                && visitScoped(
                        function,
                        () -> function.getArguments().stream().allMatch(a -> walk(a, visitor)),
                        visitor::leave);
    }
    ...
    private <T> boolean visitScoped(
            T scope, java.util.function.Supplier<Boolean> walk, Consumer<T> leave) {
        try {
            deque.push(scope);
            Boolean b = walk.get();
            leave.accept(scope);
