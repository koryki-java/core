...
public class TypecheckDBEngineTest extends BaseEngineTest<HeaderInfo> {
    ...
    @Override protected String queriesRoot() { return "src/test/resources/ai/koryki/snowflake/queries/typecheck"; }
    @Override protected String expectedCsv() { return "src/test/resources/ai/koryki/snowflake/expected/typecheck/csv"; }
    @Override protected String expectedSql() { return "src/test/resources/ai/koryki/snowflake/expected/typecheck/sql"; }
    ...
    public void testSingleFile() throws IOException {
        Path kql = Path.of("src/test/resources/ai/koryki/snowflake/queries/typecheck/privatetest/smallint_tointeger.kql");
