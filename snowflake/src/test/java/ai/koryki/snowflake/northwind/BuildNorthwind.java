...
public class BuildNorthwind {
    ...
    public static void main(String[] args) throws Exception {
        ...
        InputStream inputStream =
                BuildNorthwind.class.getResourceAsStream(
                        "/ai/koryki/databases/northwind/snowflake/data.json");
        ...
        try (Connection connection = NorthwindSnowflake.connection()) {
            ...
            Script.executeScript(
                    connection, "/ai/koryki/databases/northwind/snowflake/data_check_type.sql");
            Script.executeScript(
                    connection, "/ai/koryki/databases/northwind/snowflake/data_check_temporal.sql");

            importTable(
                    connection,
                    "INSERT INTO categories (category_id, category_name, description, root_category_id, super_category_id) VALUES (?,?,?,?,?)",
                    mapper.convertValue(
                            root.get(ExportJson.CATEGORIES),
                            new TypeReference<List<ExportJson.Category>>() {}),
                    (ps, r) -> {
            ...
            importTable(
                    ...
                    mapper.convertValue(
                            root.get(ExportJson.COUNTRIES),
                            new TypeReference<List<ExportJson.Country>>() {}),
                    (ps, r) -> {
            ...
            importTable(
                    ...
                    mapper.convertValue(
                            root.get(ExportJson.CUSTOMER_CUSTOMER_DEMO),
                            new TypeReference<List<ExportJson.CustomerCustomerDemo>>() {}),
                    (ps, r) -> {
            ...
            importTable(
                    ...
                    mapper.convertValue(
                            root.get(ExportJson.CUSTOMER_DEMOGRAPHICS),
                            new TypeReference<List<ExportJson.CustomerDemographics>>() {}),
                    (ps, r) -> {
            ...
            importTable(
                    ...
                    mapper.convertValue(
                            root.get(ExportJson.CUSTOMERS),
                            new TypeReference<List<ExportJson.Customer>>() {}),
                    (ps, r) -> {
                        ps.setString(1, r.customerId());
            ...
            importTable(
                    ...
                    mapper.convertValue(
                            root.get(ExportJson.EMPLOYEES),
                            new TypeReference<List<ExportJson.Employee>>() {}),
                    (ps, r) -> {
            ...
            importTable(
                    ...
                    mapper.convertValue(
                            root.get(ExportJson.EMPLOYEE_TERRITORIES),
                            new TypeReference<List<ExportJson.EmployeeTerritory>>() {}),
                    (ps, r) -> {
                        ps.setShort(1, r.employeeId());
            ...
            importTable(
                    ...
                    mapper.convertValue(
                            root.get(ExportJson.ORDER_DETAILS),
                            new TypeReference<List<ExportJson.OrderDetail>>() {}),
                    (ps, r) -> {
            ...
            importTable(
                    ...
                    mapper.convertValue(
                            root.get(ExportJson.ORDERS),
                            new TypeReference<List<ExportJson.Order>>() {}),
                    (ps, r) -> {
                        ps.setShort(1, r.orderId());
            ...
            importTable(
                    ...
                    mapper.convertValue(
                            root.get(ExportJson.PRODUCTS),
                            new TypeReference<List<ExportJson.Product>>() {}),
                    (ps, r) -> {
            ...
            importTable(
                    ...
                    mapper.convertValue(
                            root.get(ExportJson.REGIONS),
                            new TypeReference<List<ExportJson.Region>>() {}),
                    (ps, r) -> {
            ...
            importTable(
                    ...
                    mapper.convertValue(
                            root.get(ExportJson.SHIPPERS),
                            new TypeReference<List<ExportJson.Shipper>>() {}),
                    (ps, r) -> {
            ...
            importTable(
                    ...
                    mapper.convertValue(
                            root.get(ExportJson.SUPPLIERS),
                            new TypeReference<List<ExportJson.Supplier>>() {}),
                    (ps, r) -> {
            ...
            importTable(
                    ...
                    mapper.convertValue(
                            root.get(ExportJson.TERRITORIES),
                            new TypeReference<List<ExportJson.Territory>>() {}),
                    (ps, r) -> {
            ...
            importTable(
                    ...
                    mapper.convertValue(
                            root.get(ExportJson.US_STATES),
                            new TypeReference<List<ExportJson.UsState>>() {}),
                    (ps, r) -> {
    ...
    private static <T> void importTable(
            Connection conn, String sql, List<T> rows, RowBinder<T> binder) throws SQLException {
        ...
        System.out.println(
                "  imported " + rows.size() + " rows via: " + sql.substring(0, sql.indexOf('(')));
    }

    private static void setNullableShort(PreparedStatement ps, int idx, Short value)
            throws SQLException {
    ...
    private static void setNullableBigDecimal(PreparedStatement ps, int idx, BigDecimal value)
            throws SQLException {
