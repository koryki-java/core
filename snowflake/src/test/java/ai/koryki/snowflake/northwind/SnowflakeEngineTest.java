...
public class SnowflakeEngineTest extends BaseEngineTest<HeaderInfo> {
    ...
    protected Path localQueries() {
        return Path.of("src/test/resources/ai/koryki/snowflake/queries/northwind");
    }

    @Override
    protected Path localExpectedCsv() {
        return Path.of("src/test/resources/ai/koryki/snowflake/expected/northwind/csv");
    }

    @Override
    protected Path localExpectedSql() {
        return Path.of("src/test/resources/ai/koryki/snowflake/expected/northwind/sql");
    }
