    ...
    public ConditionEvaluationResult evaluateExecutionCondition(ExtensionContext context) {
        ...
        if (optional.isPresent()) {
            ...
            try {
                ...
                // Name the reason, not just the fact. A skip without one looks like a passing run
                // in the report, and the cause -- a missing property, an expired key, the network
