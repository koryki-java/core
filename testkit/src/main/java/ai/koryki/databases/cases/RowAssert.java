...
public class RowAssert implements TestCase {
    ...
    public RowAssert(Engine<ColumnInfo, ListResult<ColumnInfo>> engine, String kql, int rows)
            throws SQLException {
        this(engine, kql, rows, null);
    }

    public RowAssert(
            Engine<ColumnInfo, ListResult<ColumnInfo>> engine, String kql, int rows, String name)
            throws SQLException {
