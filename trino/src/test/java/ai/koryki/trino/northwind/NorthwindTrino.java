...
public class NorthwindTrino<P extends ResultProcessor<?>> extends TrinoDatabase<P> {

    public NorthwindTrino() throws SQLException {
        this("northwind", connection());
    }

    /** Connect in the given model zone (default UTC). */
    public NorthwindTrino(ZoneId modelZone) throws SQLException {
        this("northwind", connection(), modelZone);
    }

    public NorthwindTrino(String name) throws SQLException {
    ...
    public NorthwindTrino(String name, Connection conn) {
        super(name, conn);
    }

    public NorthwindTrino(String name, Connection conn, ZoneId modelZone) {
