...
/**
 * The casts corpus on Trino. It ran on DuckDB alone, which is how {@code to_integer(4.5)} could
 ...
 */
@TrinoUnavailable
public class CastsTrinoEngineTest extends BaseEngineTest<HeaderInfo> {
