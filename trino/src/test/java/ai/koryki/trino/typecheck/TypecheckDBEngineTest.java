package ai.koryki.trino.typecheck;
...
public class TypecheckDBEngineTest extends BaseEngineTest<HeaderInfo> {
    ...
    public static final String DB    = "/ai/koryki/trino/databases/typecheck";
    public static final String MODEL = "/ai/koryki/trino/databases/typecheck/model";

    public TypecheckDBEngineTest() {
        super("trino");
    }

    @Override protected String queriesRoot() { return "src/test/resources/ai/koryki/trino/queries/typecheck"; }
    @Override protected String expectedCsv() { return "src/test/resources/ai/koryki/trino/expected/typecheck/csv"; }
    @Override protected String expectedSql() { return "src/test/resources/ai/koryki/trino/expected/typecheck/sql"; }
    ...
    public void testSingleFile() throws IOException {
        Path kql = Path.of("src/test/resources/ai/koryki/trino/queries/typecheck/privatetest/smallint_tointeger.kql");
