...
public class TypecheckDBEngineTest extends BaseEngineTest<HeaderInfo> {
    ...
    @Override protected String queriesRoot() { return "src/test/resources/ai/koryki/oracle/queries/typecheck"; }
    @Override protected String expectedCsv() { return "src/test/resources/ai/koryki/oracle/expected/typecheck/csv"; }
    @Override protected String expectedSql() { return "src/test/resources/ai/koryki/oracle/expected/typecheck/sql"; }
    ...
    public void testSingleFile() throws IOException {
        Path kql = Path.of("src/test/resources/ai/koryki/oracle/queries/typecheck/privatetest/smallint_tointeger.kql");
