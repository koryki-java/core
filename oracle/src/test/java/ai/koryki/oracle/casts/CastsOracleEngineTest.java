package ai.koryki.oracle.casts;
...
/**
 * The casts corpus on Oracle. It ran on DuckDB alone, which is how {@code to_integer(4.5)} could
 ...
 */
@OracleUnavailable
public class CastsOracleEngineTest extends BaseEngineTest<HeaderInfo> {
