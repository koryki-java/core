...
public class PostgreSQLEngineTest extends BaseEngineTest<HeaderInfo> {
    ...
    protected Path localQueries() {
        return Path.of("src/test/resources/ai/koryki/postgresql/queries/northwind");
    }

    @Override
    protected Path localExpectedCsv() {
        return Path.of("src/test/resources/ai/koryki/postgresql/expected/northwind/csv");
    }

    @Override
    protected Path localExpectedSql() {
        return Path.of("src/test/resources/ai/koryki/postgresql/expected/northwind/sql");
    }
