...
public class BuildNorthwind {
    ...
    public static void main(String[] args) throws IOException, InterruptedException, SQLException {
        ...
        try (Connection connection = NorthwindPostgresql.connection()) {
            ...
            Script.executeScript(connection, "/ai/koryki/databases/northwind/postgresql/data_countries.sql");
            ...
            Script.executeScript(connection, "/ai/koryki/databases/northwind/postgresql/data_check_temporal.sql");
            Script.executeScript(connection, "/ai/koryki/databases/northwind/postgresql/data_check_type.sql");
            connection.commit();
