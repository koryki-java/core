package ai.koryki.postgresql.temporal;
...
public class TemporalDBEngineTest extends BaseEngineTest<HeaderInfo> {
    ...
    public static final String DB    = "/ai/koryki/postgresql/databases/temporal";
    public static final String MODEL = "/ai/koryki/postgresql/databases/temporal/model";

    public TemporalDBEngineTest() {
        super("postgresql");
    }

    @Override protected String queriesRoot() { return "src/test/resources/ai/koryki/postgresql/queries/temporal"; }
    @Override protected String expectedCsv() { return "src/test/resources/ai/koryki/postgresql/expected/temporal/csv"; }
    @Override protected String expectedSql() { return "src/test/resources/ai/koryki/postgresql/expected/temporal/sql"; }
    ...
    public void testSingleFile() throws IOException {
        Path kql = Path.of("src/test/resources/ai/koryki/postgresql/queries/temporal/privatetest/fetch_time_sec_from_midnight.kql");
