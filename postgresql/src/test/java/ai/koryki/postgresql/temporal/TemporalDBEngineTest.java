...
public class TemporalDBEngineTest extends BaseEngineTest<HeaderInfo> {
    ...
    public void readNorthwindDB() throws IOException, SQLException {
        ...
        engine = EngineBuilder.headers(new NorthwindPostgresql<ListWithSqlResult<HeaderInfo>>(), resolver,
    ...
    public void testSingleFile() throws IOException {
        ...
        TestUtil.test(kql, suffix(), engine, queriesRoot(), expectedCsv(), expectedSql(), getDb());
    }
}
