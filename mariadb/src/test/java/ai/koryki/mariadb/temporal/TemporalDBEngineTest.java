...
public class TemporalDBEngineTest extends BaseEngineTest<HeaderInfo> {
    ...
    public static final String DB    = "/ai/koryki/mariadb/databases/temporal";
    public static final String MODEL = "/ai/koryki/mariadb/databases/temporal/model";

    public TemporalDBEngineTest() {
        super("mariadb");
    }

    @Override protected String queriesRoot() { return "src/test/resources/ai/koryki/mariadb/queries/temporal"; }
    @Override protected String expectedCsv() { return "src/test/resources/ai/koryki/mariadb/expected/temporal/csv"; }
    @Override protected String expectedSql() { return "src/test/resources/ai/koryki/mariadb/expected/temporal/sql"; }
    ...
    public void testSingleFile() throws IOException {
        Path kql = Path.of("src/test/resources/ai/koryki/mariadb/queries/temporal/privatetest/fetch_time_sec_from_midnight.kql");
