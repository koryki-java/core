...
- category_id: A surrogate primary key that uniquely identifies a category.
...
- customer_id: A surrogate primary key used to uniquely identify each customer.
...
- mail: The mail of the contact person.
...
- employee_id: A surrogate primary key used to uniquely identify each employee.
...
- working_hour_from: Workinghour from.

- working_hour_to: Workinghour to.
...
- extension: The internal telephone extension of the employee.
...
- order_id: A surrogate primary key used to uniquely identify each order.
...
- delivered_date: The date the order was delivered.

- ship_via: A foreign key identifying the shipper.

- freight: The carriage charged for the order, an amount and not a weight.
...
- order_id: A foreign key identifying the order.
...
- product_id: A surrogate primary key used to uniquely identify each product.
...
- region_id: A surrogate primary key used to uniquely identify each region.

- region_description: A description to the region.

## shippers
Stores information to shippers.
- shipper_id: A surrogate primary key used to uniquely identify each shipper.
...
- supplier_id: A surrogate primary key used to uniquely identify each supplier.
...
- mail: Mail of the company.

- homepage: Homepage of the supplier company.

## territories
Stores Territories.
- territory_id: A surrogate primary key used to uniquely identify each territory.

- territory_description: Description of the territory.

## us_states
US States.
- state_id: A surrogate primary key used to uniquely identify each state.
