...
public class TypecheckDBEngineTest extends BaseEngineTest<HeaderInfo> {
    ...
    public static final String DB    = "/ai/koryki/mssql/databases/typecheck";
    public static final String MODEL = "/ai/koryki/mssql/databases/typecheck/model";

    public TypecheckDBEngineTest() {
        super("mssql");
    }

    @Override protected String queriesRoot() { return "src/test/resources/ai/koryki/mssql/queries/typecheck"; }
    @Override protected String expectedCsv() { return "src/test/resources/ai/koryki/mssql/expected/typecheck/csv"; }
    @Override protected String expectedSql() { return "src/test/resources/ai/koryki/mssql/expected/typecheck/sql"; }
    ...
    public void testSingleFile() throws IOException {
        Path kql = Path.of("src/test/resources/ai/koryki/mssql/queries/typecheck/privatetest/to_text/numeric.kql");
